 ...
 * @returns {Promise<{md5:string, storage_key:string, etag:string, size:number, content_type:string, original_name:string, preview_url:string, url:string, preprocess_note?:string, before_bytes?:number, after_bytes?:number}>}
 */
